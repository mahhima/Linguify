...
class ReminderReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notification = NotificationCompat.Builder(context, "daily_reminder_channel")
            ...
            .setContentText("Open Linguify and learn something new today!")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel("daily_reminder_channel", "Daily Reminders", NotificationManager.IMPORTANCE_DEFAULT)
